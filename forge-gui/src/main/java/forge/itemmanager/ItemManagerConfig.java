...
public enum ItemManagerConfig {
    ...
    CONTRAPTION_DECK_EDITOR_LIMITED(SColumnUtil.getCatalogDefaultColumns(false), true, false, true,
            null, null, 4, 0),
    STICKER_SHEET_POOL(SColumnUtil.getSpecialCardPoolDefaultColumns(), true, false, true,
            null, null, 4, 0),
    STICKER_SHEET_DECK_EDITOR(SColumnUtil.getCatalogDefaultColumns(true), true, false, true,
            null, null, 4, 0),
